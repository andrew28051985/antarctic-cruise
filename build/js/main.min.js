...
/* harmony import */ var _utils_no_js_nav__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/no-js-nav */ "./js/utils/no-js-nav.js");
...
/* harmony import */ var _modules_card_cruise_card_cruise__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/card-cruise/card-cruise */ "./js/modules/card-cruise/card-cruise.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_utils_no_js_nav__WEBPACK_IMPORTED_MODULE_1__["getNavNoJs"])();
  Object(_utils_scroll_link__WEBPACK_IMPORTED_MODULE_4__["scrollToLink"])(); // Modules
  // ---------------------------------
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_form_form__WEBPACK_IMPORTED_MODULE_3__["validityForm"])(_modules_form_form__WEBPACK_IMPORTED_MODULE_3__["inputPhone"], _modules_form_form__WEBPACK_IMPORTED_MODULE_3__["inputEmail"]);
    Object(_modules_form_form__WEBPACK_IMPORTED_MODULE_3__["sendUserFormData"])(_modules_form_form__WEBPACK_IMPORTED_MODULE_3__["bookingForm"]);
    Object(_utils_scroll_link__WEBPACK_IMPORTED_MODULE_4__["breakpointChecker"])();
    Object(_modules_card_cruise_card_cruise__WEBPACK_IMPORTED_MODULE_5__["breakpointCheckerOnClickButtonCruise"])();
    Object(_modules_card_cruise_card_cruise__WEBPACK_IMPORTED_MODULE_5__["breakpointCheckerOffClickButtonCruise"])();
  });
}); // ---------------------------------
...
/*!***********************************************!*\
  !*** ./js/modules/card-cruise/card-cruise.js ***!
  \***********************************************/
/*! exports provided: breakpointCheckerOnClickButtonCruise, breakpointCheckerOffClickButtonCruise */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "breakpointCheckerOnClickButtonCruise", function() { return breakpointCheckerOnClickButtonCruise; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "breakpointCheckerOffClickButtonCruise", function() { return breakpointCheckerOffClickButtonCruise; });
var cruiseItem = document.querySelectorAll('.next-cruise__item');
var breakpoint = window.matchMedia('(max-width:1023px)');
var breakpointDesctop = window.matchMedia('(min-width:1024px)');
var countClick = 0;
...
var onBlurListener = function onBlurListener() {
  countClick = 0;
};
...
var onFocusCard = function onFocusCard() {
  cruiseItem.forEach(function (item) {
    item.addEventListener('focus', onFocusListener(item));
  });
};

var onMouseOutCard = function onMouseOutCard() {
  cruiseItem.forEach(function (item) {
...
var breakpointCheckerOnClickButtonCruise = function breakpointCheckerOnClickButtonCruise() {
  if (breakpoint.matches) {
    countClick = 0;
    onMouseOutCard();
    onFocusCard();
...
var breakpointCheckerOffClickButtonCruise = function breakpointCheckerOffClickButtonCruise() {
...
/*!*********************************!*\
  !*** ./js/modules/form/form.js ***!
  \*********************************/
/*! exports provided: validityForm, sendUserFormData, bookingForm, inputPhone, inputEmail */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var validityEmail = /^[A-Za-z0-9]{1,19}@[A-Za-z0-9]{1,19}.{1,20}$/;
var validityInputNumber = /^[0-9]{1,20}$/;
var bookingForm = document.querySelector('.booking__form');
var inputPhone = bookingForm.querySelector('#phone');
var inputEmail = bookingForm.querySelector('#email');
var MIN_LENGTH_PHONE = 5;
var MAX_LENGTH_PHONE = 11;
...
var validityForm = function validityForm(namePhone, nameEmail) {
  ...
  nameEmail.addEventListener('input', function (evt) {
...
var Modals = /*#__PURE__*/function () {
  ...
  _createClass(Modals, [{
    ...
    value: function close() {
      ...
      if (modal && modal.classList.contains('modal--nav')) {
        var modalNav = document.querySelector('.modal__content-wrapper-nav');
        var nav = modalNav.querySelector('.main-nav');
...
/*!*******************************!*\
  !*** ./js/utils/no-js-nav.js ***!
  \*******************************/
/*! exports provided: getNavNoJs */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getNavNoJs", function() { return getNavNoJs; });
var buttonNav = document.querySelector('.page-header__toggle-nav');
var nav = document.querySelector('.page-header__wrapper-nav');
var cruise = document.querySelector('.cruise');
var cruiseWrapper = cruise.querySelector('.cruise__wrapper');

var getNavNoJs = function getNavNoJs() {
...
/*!*********************************!*\
  !*** ./js/utils/scroll-link.js ***!
  \*********************************/
/*! exports provided: scrollToLink, breakpointChecker */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var nextCruise = document.querySelector('#next-cruise');
var contacts = document.querySelector('#contacts');
var links = document.querySelectorAll('.main-nav__item-link');
var isModalActive = document.querySelector('[data-modal="navigation"]');
  ...
  links.forEach(function (link) {
    link.addEventListener('click', function (evt) {
      ...
      if (isModalActive && isModalActive.classList.contains('is-active')) {
        _modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_0__["modals"].close('navigation');
        setTimeout(function () {
...
var ScrollLock = /*#__PURE__*/function () {
  ...
  _createClass(ScrollLock, [{
    ...
    key: "_getBodyScrollElement",
    value: function _getBodyScrollElement() {
      setTimeout(function () {
