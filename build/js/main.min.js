...
var cruiseDescription = document.querySelectorAll('.next-cruise__wrapper');
var breakpoint = window.matchMedia('(max-width:1023px)');
var breakpointDesctop = window.matchMedia('(min-width:1024px)');
var countClick = 0;

var onEventListener = function onEventListener(evt) {
  if (countClick === 0) {
    evt.preventDefault();
    ++countClick;
...
var onClickCard = function onClickCard() {
  cruiseDescription.forEach(function (description) {
